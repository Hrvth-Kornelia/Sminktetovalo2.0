...
window.addEventListener("load", function () {
    ...
    const loader = document.getElementById("luxoria-loader");

    function inditFadeAnimaciokat(){

        document.querySelectorAll(".fade, .fade-up").forEach((elem,index)=>{
